...
class Language extends \Application\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Language' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Language' . "\0" . 'iso2', '' . "\0" . 'Application\\Entity\\Language' . "\0" . 'title', '' . "\0" . 'Application\\Entity\\Language' . "\0" . 'titleEn');
        }

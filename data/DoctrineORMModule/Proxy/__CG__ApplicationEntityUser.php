...
class User extends \Application\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'password', 'settings', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'Application\\Entity\\User' . "\0" . 'name');
        }
